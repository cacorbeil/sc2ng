...
var KEY_RANKS_STORAGE = 'WARSHOP@@!!NGRANKS102';
var KEY_DATE_STORAGE = 'WARSHOP@@102!!NGDATE';
...
function Player(id, name, displayName) {
   ...
   this.BonusPool = 0; this.BonusDate = null;
};
...
function drawPlayer(p, table) {
   var rowIndex = table.row.add(p).order([0, 'desc'], [4, 'desc']).draw().index();
